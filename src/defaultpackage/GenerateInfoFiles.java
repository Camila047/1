...
//            this.quantity = quantity;
	...
	/*
	 * Main method Purpose: Execute the code to generate the files. Process: Create
	 * Vendors: Creates a list of vendors with sample information. Create Sales:
	 * Creates a list of sales for a specific salesperson. Generate Files: Calls
	 * generateSalesFile to create the sales file for the first salesperson. Call
	 * generateSalesmenInfoFile to create the salesmen information file. Calls
	 * generateProductsFile to create the products information file. Exception
